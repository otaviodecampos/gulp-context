...
function Context(name, conf, parsers) {
    ...
    this.setup = function () {
        ...
        scope = utils.copy(gulpc.getConf().scope);
    ...
    this.getDependencies = function () {
        ...
        if(fromTargetContext) {
            dependencies = dependencies.concat(fromTargetContext);
        }
    ...
    this.getFromTargetContext = function () {
        return conf.fromTargetContext;
    }
